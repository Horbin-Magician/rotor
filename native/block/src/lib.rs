...
#![deny(deprecated, missing_abi, uninhabited_static)]
...
// Only the address of the runtime class is used. An empty enum is
// uninhabited and cannot be the type of an extern static.
#[repr(C)]
