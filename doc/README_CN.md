...
- 输入及划词翻译，支持 Google 与 AI 翻译；全局 AI 服务商设置支持 DeepSeek、OpenAI、Claude 和自定义服务。
...
公开发布及 stable/preview 推广见[发布操作说明](../native/release-operations.md)。
...
GitHub Actions 收到 tag 后创建 Release 草稿，人工审核后手动发布。
